...
def display_score():
	...
	score_surface = test_font.render(f"Score: {int(current_time / 1000)}", False, (64, 64, 64))
...
pygame.display.set_caption("Mariel")
...
game_title = test_font.render("Mariel", False, (111, 196, 169))
game_title_rect = game_title.get_rect(center = (400, 50))
game_message = test_font.render("Press space run", False, (111, 196, 169))
